...
class MedicineManyTimesDayScreen extends StatefulWidget {
  final GlobalKey<FormState> formKey;
  final int initialValue;
  final String selectedFrequency;
  final ValueChanged<String> onNameChanged;

  const MedicineManyTimesDayScreen({
    super.key,
  ...
  @override
  State<MedicineManyTimesDayScreen> createState() =>
      _MedicineManyTimesDayScreenState();
}

class _MedicineManyTimesDayScreenState
    extends State<MedicineManyTimesDayScreen> {
  ...
  @override
  void didUpdateWidget(covariant MedicineManyTimesDayScreen oldWidget) {
