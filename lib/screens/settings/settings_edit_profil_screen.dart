...
class _SettingsEditProfilScreenState
    extends State<SettingsEditProfilScreen> {
...
void initState() {
  ...
  void dispose() {
    ...
    _genderController.removeListener(
      _checkFormChanges,
    );
