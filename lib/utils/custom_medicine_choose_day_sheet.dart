...
class CustomMedicineChooseDaySheet extends StatefulWidget {
  final GlobalKey<FormState> formKey;
  final ValueChanged<String> onNameChanged;
  final List<int>? initialSelectedDays;

  const CustomMedicineChooseDaySheet({
    super.key,
  ...
  @override
  State<CustomMedicineChooseDaySheet> createState() =>
      _CustomMedicineChooseDaySheetState();
}

class _CustomMedicineChooseDaySheetState
    extends State<CustomMedicineChooseDaySheet> {
  ...
  @override
  void didUpdateWidget(covariant CustomMedicineChooseDaySheet oldWidget) {
