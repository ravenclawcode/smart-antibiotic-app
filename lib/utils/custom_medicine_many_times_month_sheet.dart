...
class CustomMedicineManyTimesMonthSheet extends StatefulWidget {
  final GlobalKey<FormState> formKey;
  final String initialValue;
  final ValueChanged<String> onNameChanged;

  const CustomMedicineManyTimesMonthSheet({
    super.key,
  ...
  @override
  State<CustomMedicineManyTimesMonthSheet> createState() =>
      _CustomMedicineManyTimesMonthSheetState();
}

class _CustomMedicineManyTimesMonthSheetState
    extends State<CustomMedicineManyTimesMonthSheet> {
  ...
  @override
  void didUpdateWidget(covariant CustomMedicineManyTimesMonthSheet oldWidget) {
