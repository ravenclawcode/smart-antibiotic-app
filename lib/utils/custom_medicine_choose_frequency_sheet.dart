...
class CustomMedicineChooseFrequencySheet extends StatefulWidget {
  final GlobalKey<FormState> formKey;
  final String initialValue;
  final ValueChanged<String> onNameChanged;

  const CustomMedicineChooseFrequencySheet({
    super.key,
  ...
  @override
  State<CustomMedicineChooseFrequencySheet> createState() =>
      _CustomMedicineChooseFrequencySheetState();
}

class _CustomMedicineChooseFrequencySheetState
    extends State<CustomMedicineChooseFrequencySheet> {
  ...
  @override
  void didUpdateWidget(covariant CustomMedicineChooseFrequencySheet oldWidget) {
