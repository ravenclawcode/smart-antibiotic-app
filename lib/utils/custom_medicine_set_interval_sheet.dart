...
class CustomMedicineSetIntervalSheet extends StatefulWidget {
  ...
  const CustomMedicineSetIntervalSheet({
    super.key,
  ...
  @override
  State<CustomMedicineSetIntervalSheet> createState() =>
      _CustomMedicineSetIntervalSheetState();
}

class _CustomMedicineSetIntervalSheetState extends State<CustomMedicineSetIntervalSheet> {
  ...
  @override
  void didUpdateWidget(covariant CustomMedicineSetIntervalSheet oldWidget) {
